...
<?php
	...
	$query ="	UPDATE Indirizzo_Spedizione
				SET Name_Surname=?,Address_1=?,Address_2=?,City=?,Province=?,CAP=?,Paese=?,Phone=?
				WHERE IDShipment = ?";
	$parametri = array($_POST['Destinatario'],$_POST['Indirizzo1'],$_POST['Indirizzo2'],$_POST['Citta'],$_POST['Provincia'],$_POST['CAP'],$_POST['Paese'],$_POST['Tel'], $_POST['ID']);

	$connessione->doQP($query,$parametri);
	extRT("Indirizzo di spedizione aggiornato con successo", "myaccount.php", 5000);		
